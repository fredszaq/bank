 ...
 * 
 */
public class VirementExternePage extends BankRootPage {

	@Override
	public final String getUrl() {
		return TestConstants.BASE_URL + "secure/virement/externe.html";
	}
	...
	public final void fillFormAndSend(String compteDebiteur,
		...
		findFirst("#compteDebiteur option[value=" + compteDebiteur + "]")
				.click();
		fill("#compteCrediteur").with(compteCrediteur);
